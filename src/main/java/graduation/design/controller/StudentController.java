...
public class StudentController {
    ...
    @ApiOperation("查询学生列表,接口权限admin,teacher")
    @GetMapping("/list")
    public Result list(){
        List<User> students = userService.list(new QueryWrapper<User>().like("role_list","student").select("id","account","name","avatar","last_login"));
